...
const BROWSER_GLOBALS = {
  ...
  EditorShortcutManager: 'readonly',
  BatchUIManager: 'readonly',
  SessionManager: 'readonly',
  SessionCoordinator: 'readonly',
  ZoomPanManager: 'readonly',
  ...
  ensureJSZip: 'readonly',
  ensureHeic2any: 'readonly',
  ...
  originalExtension: 'writable',
  originalWidth: 'writable',
  originalHeight: 'writable',
  transformResetImage: 'writable',
  currentRotation: 'writable',
  isFlippedHorizontally: 'writable',
  isFlippedVertically: 'writable',
  currentZoom: 'writable',
  panX: 'writable',
  panY: 'writable',
  isRulerMode: 'writable',
  ...
  // Estado de watermark/drag de main.js usado por watermark-manager.js (v3.7.1)
  isDragging: 'writable',
  dragTarget: 'writable',
  dragOffsetX: 'writable',
  dragOffsetY: 'writable',
  isPositioningMode: 'writable',
  isTextPositioningMode: 'writable',
  lastPositioningModeActivated: 'writable',
  hoveredWatermark: 'writable',
  watermarkImagePreview: 'writable',
  textWatermarkBounds: 'writable',
  imageWatermarkBounds: 'writable',
  textLayerBounds: 'writable',
  activeLayerId: 'readonly',
  isZoomed: 'writable',
  isPanning: 'writable',
  textLayerManager: 'readonly',
  ...
  _openAccessibleModal: 'readonly',
  _closeAccessibleModal: 'readonly',
  renderHistoryPanel: 'readonly',
  updateRotationDisplay: 'readonly',
  // Funciones de main.js usadas por watermark-manager.js (v3.7.1)
  updatePreview: 'readonly',
  getCanvasContentRect: 'readonly',
  renderCanvasWithLayers: 'readonly',
  renderCanvasWithLayersLightweight: 'readonly',
  updateTextLayersList: 'readonly',
  selectTextLayer: 'readonly',
