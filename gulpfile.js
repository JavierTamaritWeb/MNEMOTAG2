...
const JS_FILES = [
  ...
  'js/managers/text-layer-ui-manager.js',
  'js/managers/watermark-manager.js',
  'js/managers/document-renderer.js',
  'js/managers/batch-manager.js',
  'js/managers/batch-ui-manager.js',
  ...
  'js/managers/session-coordinator.js',
  'js/managers/export-manager.js',
  'js/managers/zoom-pan-manager.js',
  'js/managers/ruler-manager.js',
  'js/managers/comparison-manager.js',
  'js/managers/mobile-manager.js',
  'js/managers/editor-shortcut-manager.js',
